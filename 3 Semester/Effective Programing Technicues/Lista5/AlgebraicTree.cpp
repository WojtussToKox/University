...
AlgebraicTree::AlgebraicTree(AlgebraicTree&& otherTree)
{
	std::cout << "MOVE CONSTR ";

	this->pRoot = otherTree.pRoot;

	this->variables = std::move(otherTree.variables);

	otherTree.pRoot = NULL;
	otherTree.variables.clear();
}

AlgebraicTree& AlgebraicTree::operator=(AlgebraicTree&& otherTree)
{
	std::cout << "MOVE OP= ";
